var API_KEY = 'e31cab03c38e4dd38a4e113e1a1dbfcf';
var weather = [];
var forecast = [];
...
var fetchWeatherData = function(city) {
 const url = 'https://api.openweathermap.org/data/2.5/weather?q=' + city + '&limit=1&units=imperial&appid=' + API_KEY;
...
var renderCurrentWeather = function() {
  ...
  for (let i = 0; i < weather.length; i++) {
    ...
    document.querySelector('.weather').insertAdjacentHTML('beforeend', template);
  }
}

var fetchForecastData = function(city) {
  const url = 'https://api.openweathermap.org/data/2.5/forecast?q=' + city + '&limit=1&units=imperial&appid=' + API_KEY;
